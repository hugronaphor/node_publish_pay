  ...
  <?php if (!$is_payment_completed) : ?>
    <div class="paypal-button">
      <form action="<?php print $paypal_host; ?>/cgi-bin/webscr" method="post" target="_top">
        ...
        <input type="hidden" name="hosted_button_id" value="ASHYAZKR2FEY8">
        <table>
          <tr><td><input type="hidden" name="on0" value="Promotion options">Promotion options</td></tr><tr><td><select name="os0">
